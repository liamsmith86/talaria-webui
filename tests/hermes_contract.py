...
observations.after(
    ...
    turn_id="interrupted",
    api_request_id="tool",
    usage={"prompt_tokens": 900, "output_tokens": 100},
    api_duration=2,
)
observations.before(
    task_id="contract",
    turn_id="interrupted",
    api_request_id="waiting",
    request={"reasoning_effort": "high"},
    started_at=interrupt_start + 3,
    model="interrupted-model",
    provider="test",
)
interrupted_reply = db.append_message(
    "contract", "assistant", "Operation interrupted.", timestamp=interrupt_start + 4
)
